                ...
                <div class="board_wrap">
                    <div class="information">
                        ...
                        <ul class="information-phon">
                            ...
                            <a href="{{ route('member_info_index') }}"><button>변경</button></a>
                        </ul>
                    ...
                    <div class="information information_01">
                        <div class="information-inner-title">
                            <h4>배송지</h4>
                            @if(empty($address))
                            <button id="btn" onclick='changeBtnName()'>배송지 입력 + </button>    <!-- 배송지 입력버튼 -->
                            @else
                            <button onclick="aa()">배송지 설정 / 변경</button> <!-- 클릭햇을때 배송지 입력버튼 -->
                            @endif
