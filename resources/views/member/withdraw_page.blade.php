                    ...
                    <div class="list_02">
                        <div class="secession_02">
                          ...
                          <ul class="secession_radio_btn">
                            ...
                            <li><input type="radio" name="withdraw_type" id="withdraw_type3" value="고객응대가 불만이에요(상담, 문의 등)" onclick="withdraw_type_chk(3)"> <label for="">고객응대가 불만이에요(상담, 문의 등)</label></li>
                            <li><input type="radio" name="withdraw_type" id="withdraw_type4" value="배송, 교환, 환불, 반품이 불만이에요" onclick="withdraw_type_chk(4)"> <label for="">배송, 교환, 환불, 반품이 불만이에요.</label></li>
                            <li><input type="radio" name="withdraw_type" id="withdraw_type5" value="상품이 부족해요" onclick="withdraw_type_chk(5)"> <label for="">상품이 부족해요</label></li>
                            <li><input type="radio" name="withdraw_type" id="withdraw_type6" value="컨텐츠가 불만이에요" onclick="withdraw_type_chk(6)"> <label for="">컨텐츠가 불만이에요</label></li>
                            <li><input type="radio" name="withdraw_type" id="withdraw_type7" value="UI/UX가 불편해요" onclick="withdraw_type_chk(7)"> <label for="">UI/UX가 불편해요</label></li>
                            <li><input type="radio" name="withdraw_type" id="withdraw_type8" value="기타(직접입력)" onclick="withdraw_type_chk(8)"> <label for="">기타(직접입력)</label></li>
