            ...
            <div class="board mypage_list">
                ...
                <div class="board_wrap">
                    <div class="tab_menu">
                        <ul class="list_tab">
                            <li class="is_on">
                                <a href="#tab1" class="btn_list">전체 ({{ number_format($total_cnt) }})</a>
                            </li>
                            <li>
                                <a href="#tab2" class="btn_list">쇼핑 ({{ number_format($item_cnt) }})</a>
                            </li>
                            <li>
                                <a href="#tab3" class="btn_list">소식 ({{ number_format(count($notice_infos)) }})</a>
                            </li>
                            <li>
                                <a href="#tab4" class="btn_list">평가단 ({{ number_format(count($exp_infos)) }})</a>
                            </li>
                        </ul>
