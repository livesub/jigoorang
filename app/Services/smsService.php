...
class smsService
{
    ...
    public function auth_certification($user_phone){
        ...
        $sms['user_id'] = config('app.aligo_id'); // SMS 아이디
        $sms['key'] = config('app.aligo_app_key');//인증키
        /****************** 인증정보 끝 ********************/
    ...
    public function get_list_sms_form_id($id){
        /*************  문자전송 결과 상세보기 *****************/
