        ...
        <!-- 이용약관 시작  -->
            <div class="terms">
                ...
                <div class="terms_wrap">
                    ...
                    <h4 class="mb-20">제3조(약관 등의 명시와 설명 및 개정)</h4>
                    ...
                    <h4 class="mb-20">제4조(서비스의 제공 및 변경)</h4>
                    ...
                    <h4 class="mb-20">제7조(회원 탈퇴, 자격 상실 및 서비스 이용 제한 등)</h4>
                    ...
                    <h4 class="mb-20">제8조(회원에 대한 통지)</h4>

                    <p>① “몰”이 회원에 대한 통지를 하는 경우, 회원이 “몰”과 미리 약정하여 지정한 전자우편 주소나 휴대폰 문자로 할 수 있습니다.<br><br>

                    ② “몰”은 불특정다수 회원에 대한 통지의 경우 1주일 이상 “몰” 게시판에 게시함으로서 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.<br></p>

                    <br><br>

                   <h4 class="mb-20"> 제9조(구매신청 및 개인정보 제공 동의 등) </h4>
                    ...
                    <h4 class="mb-20">제12조(수신확인통지•구매신청 변경 및 취소)</h4>
                    ...
                    <h4 class="mb-20">제13조(재화 등의 공급)</h4>
                    ...
                    ③ 제2항 제2호 내지 제4호의 경우에 “몰”이 사전에 청약철회 등이 제한되는 사실을 소비자가 쉽게 알 수 있는 곳에 명기하거나 시용상품을 제공하는 등의 조치를 하지 않았다면 이용자의 청약철회 등이 제한되지 않습니다.<br><br>
                    ...
                    <h4 class="mb-20">제16조(청약철회 등의 효과)</h4>
                    <p>
                    ...
                    <h4 class="mb-20">제19조(회원의 ID 및 비밀번호에 대한 의무)</h4>
                    <p>
                    ...
                    <h4 class="mb-20">제20조(이용자의 의무) 이용자는 다음 행위를 하여서는 안 됩니다.</h4>
                    <p>
                    ...
                    <h4 class="mb-20">제21조(연결“몰”과 피연결“몰” 간의 관계)</h4>
                    <p>
                    ...
                    <h4 class="mb-20">제22조(저작권의 귀속 및 이용제한)</h4>
                    <p>
                    ...
                    <h4 class="mb-20">제24조(재판권 및 준거법)</h4>
                    <p>
