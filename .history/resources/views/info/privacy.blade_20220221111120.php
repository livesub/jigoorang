            ...
            <div class="terms">
                ...
                <div class="terms_wrap">
                    ...
                    <p>
                        ...
                        다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는<br>
                        ...
                        1. 일반 회원 정보<br>
                        - 수집 시기 : 가입시<br>
                        - 수집 항목 : 이름, 이메일 주소, 비밀번호, 핸드폰번호, 생년월일, 성별<br>
                        - 이용 목적: 회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정이용 방지, 각종 고지·통지, 고충처리, 새로운 서비스 및 신상품이나 이벤트 정보 등의 안내
                        <br><br>
                        2. 제품 평가단 정보<br>
                        - 수집 시기 : 제품 평가단 신청시<br>
                        - 수집 항목 : <br>
                        ① 신청자의 이름, 핸드폰 번호, 이메일 주소<br>
                        ② 배송 수령인의 이름, 핸드폰 번호, 주소<br>
                        - 이용목적: 평가단 응모접수 관리, 물품 발송 및 수령 확인, 평가단 진행을 위한 고지 및 문의 <br>응대, (필요시)제세공과금 납부관련 안내, 평가 리뷰 작성시 선정된 평가단 식별·인증<br>
                        <br>
                        3. 주문정보<br>
                        - 수집 시기 : 주문시<br>
                        - 수집 항목 : <br>
                        ① 주문자의 정보(이름, 이메일 주소, 비밀번호, 핸드폰번호)<br>
                        ② 수취자의 정보(이름, 주소, 휴대폰 번호)  <br>
                        ③ 결제 승인정보<br>
                        - 이용목적: 주문 상품의 결제 및 배송
                    ...
                    <p>
                        ① 이용자가 쇼핑몰 회원으로서 지구랭에서 제공하는 서비스를 이용하는 동안 지구랭은 이용자들의 개인정보를 계속적으로 보유하며 서비스 제공 등을 위해 이용합니다.
                        고객의 개인정보는 회원탈퇴 등 수집목적 또는 제공받은 목적이 달성되면 파기하는 것을 원칙으로 합니다.
                        단, 『전자상거래 등에서의 소비자보호에 관한 법률』 등 관련법령의 규정에 의하여 다음과 같이 거래 관련 권리 의무 관계의 확인 등을 일정기간 보유하여야 할 필요가 있을 경우에는 그 기간동안 보유합니다.
                        <br><br>
                        가. 『전자상거래 등에서의 소바자보호에 관한 법률』 제6조<br>
                        - 계약 또는 청약 철회 등에 관한 기록: 5년<br>
                        - 대금결제 및 재화 등의 공급에 관한 기록: 5년<br>
                        - 소비자의 불만 또는 분쟁처리에 관한 기록: 3년<br>
                        <br>
                        나. 『통신비밀보호법』 제15조의 2<br>
                        - 방문(로그)에 관한 기록: 1년
                        <br><br>
                        다. 기타 관련 법령 등
                    </p>
                    ...
                    <p>
                        ① 지구랭은 고객의 개인정보를 “제1조 개인정보의 수집항목 및 이용목적”에서 고지한 범위를 넘어 이용하거나 타인 또는 타기업, 기관에 제공하지 않습니다. 다만 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.<br><br>
                    ...
                    <p>
                        ...
                        ⑥ 지구랭은 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.<br>
                    </p>
