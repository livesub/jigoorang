                    ...
                    <div class="scrollmenu sub_sol">
                        <div class="swiper submenu_sol">
                            <ul class="swiper-wrapper submenu_innr">
                              ...
                              <a href="{{ route('sitem','ca_id='.$ca_id.'&sub_ca_id='.$sub_cate_info->sca_id.'&sub_cate='.$sub_cate_num) }}" id="sd_{{ $sub_cate_info->id }}" class="swiper-slide">
                               <li><span {!! $class_chk !!}>{{ $sub_cate_info->sca_name_kr }}</span></a></li>
                                @php
                                    $sub_cate_num++;
                                @endphp
                              @endforeach
