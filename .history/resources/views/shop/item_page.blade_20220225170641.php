                    ...
                    <div class="scrollmenu sub_sol">
                        <div class="swiper submenu_sol">
                            <ul class="swiper-wrapper submenu_innr">
                              <li class="swiper-slide" onClick="location.href='{{ route('sitem','ca_id='.$cate_info->sca_id.'&cate='.$cate_num) }}'"onClick="location.href='{{ route('sitem','ca_id='.$cate_info->sca_id.'&cate='.$cate_num) }}'">
