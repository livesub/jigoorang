                ...
                <div class="board_wrap">
                    <div class="scrollmenu">
                        <div class="swiper submenu">
                            <ul class="swiper-wrapper submenu_h sol_g_l">
                                @php
                                    $cate_num = 0;
                                @endphp
...
<script>
    if($(".submenu_h li").hasClass("bct_active") === true) {
        $(this).parent().removeclass('active')

출처: https://eunyoe.tistory.com/80 [eunyo의 it이야기]
