                            ...
                            <div class="list ev_rul inner od">
                                ...
                                @foreach($cart_infos as $cart_info)
                                    @php
                                        ...
                                        $sum = DB::select("select SUM(IF(sio_type = 1, (sio_price * sct_qty), ((sct_price + sio_price) * sct_qty))) as price, SUM(sct_point * sct_qty) as point, SUM(sct_qty) as qty from shopcarts where sct_select = 1 and item_code = '{$cart_info->item_code}' and od_id = '$s_cart_id' ");
var_dump($sum);
                                        if (!$goods)
                                        {
