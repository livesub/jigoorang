...
<script>
    alert("현재 재고수량보다 많은 수량을 주문하셨습니다./n재고 수량내에서 주문부탁드려요./n*추가 입고 요청은 [고객센터] – [1:1문의]를 이용해주세요");
</script>
    <!-- 서브 컨테이너 시작 -->
            ...
            <div class="board mypage_list">
                ...
                <div class="board_wrap">
                    <div class="cart_list">
                                ...
                                <div class="cart">
                                           ...
                                           <ul class="c_s_tt">
                                                @if($cart_info->item_cust_price > 0)
                                                    @php
                                                        ...
                                                        if($cart_info->item_cust_price > 0){
                                                            //시중가격 값이 있을때 할인율 계산
                                                            $discount = (int)$cart_info->item_cust_price - ((int)$cart_info->item_price + $item_options->sio_price); //할인액
                                    ...
                                    <div class="cart_inner_01">
                                        ...
                                        <ul class="cart_list_pr_m none">
                                            ...
                                            <li>
                                                <button class="btn-50" type="button" onclick="return form_check('each_buy', {{ $cart_info->id }});">구매하기</button>
                        ...
                        <span class="cr_03 ft_sz">※ 배송지가 도서산간지역이거나 부피나 중량이 큰 일부 제품의 경우 추가 배송비가 발생할 수 있습니다</span>

                        <div class="list_sol_bk mt-20"></div>
