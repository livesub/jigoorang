                                ...
                                <div class="pr_body pd-00">
                                    <div class="pt_name m-00">
                                        ...
                                        <ul class="oder_point">
                                            ...
                                            <li>
                                            <div class="">
                                              <input type="text" name="od_temp_point" value="0" id="od_tem_point" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');all_point_use(false);">
                                              <span>P</span>

                                              <button type="button" class="" onclick="all_point_use(true);">전액 사용</button>
                                            </div>
                                            </li>
                                        </ul>
                                        @endif
