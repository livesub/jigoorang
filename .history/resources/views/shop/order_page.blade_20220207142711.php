...
var_dump("99999====> ".$hap_sendcost);
                                ...
                                @php
                                    ...
                                    if($tot_sell_price >= $de_send_cost_free){
                                        $total_sendcost = $hap_sendcost;
                                    }else{
                                        $total_sendcost = $hap_sendcost + $de_send_cost;
                                    }
var_dump("hap_sendcost===> ".$total_sendcost);
                                    //총결제금액 = 상품 총금액 + 배송비
                                    $tot_price = $tot_sell_price + $total_sendcost;
                                @endphp
