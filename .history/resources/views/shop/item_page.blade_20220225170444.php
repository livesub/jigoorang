                    ...
                    <div class="scrollmenu">
                        <div class="swiper submenu">
                            <ul class="swiper-wrapper submenu_h">
                                ...
                                <li class="sub_cate swiper-slide {{ $ca_id_class }}" onClick="location.href='{{ route('sitem','ca_id='.$cate_info->sca_id.'&cate='.$cate_num) }}'"><a href="{{ route('sitem','ca_id='.$cate_info->sca_id.'&cate='.$cate_num) }}" class="">{{ $cate_info->sca_name_kr }}  </a></li>
