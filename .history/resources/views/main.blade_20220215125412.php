                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="sub-img-3">
                                        ...
                                        @endphp
                                            <a href="{{ route('sitemdetail') }}?item_code={{ $special_one->item_code }}">
                                                <h3>{{ $item_manufacture }} {{ stripslashes($special_one->item_name) }}</h3>
                                            </a>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                @endphp
                                    ...
                                    <span class="main-project-left">
                                        <p class="price ml-10">{{ $CustomUtils->display_price($new_arrival->item_price, $new_arrival->item_tel_inq) }}</p>
