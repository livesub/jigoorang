                ...
                <div class="box_cont">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="prt">
                                <label>
                                    <input type="radio" id="give_point1" name="give_point" value="1" checked="checked" > 지급
                                </label>
                                <label>
                                    <input type="radio" id="give_point2" name="give_point" value="2"> 회수
                                </label>
                                <div>
                                    <input class="mr05" type="number" name="" placeholder=""> P
                                    <button type="button" class="btn blk-ln ht34" onclick="">확인</button>
                                </div>
                            </div>
                        </div>
                    </div>
