...
<table border=1>
    <tr>
        <td><b>적립률</b></td>
        <td>
            <input type="text" name="tot_item_point" value="{{ $tot_item_point }}" id="tot_item_point" class="frm_input" size="10"> %
        </td>
    </tr>
</table>
    ...
    <tr>
        <td>
            <table border=1>
                <tr>
                    <td>배송업체명</td>
                    <td><input type="text" name="send_company_name" value="{{ $send_company_name }}"></td>
                </tr>
                <tr>
                    <td>배송업체전화번호</td>
                    <td><input type="text" name="send_company_tel" value="{{ $send_company_tel }}"></td>
                </tr>
                <tr>
                    <td>배송업체 배송 조회 URL</td>
                    <td><input type="text" name="send_company_url" value="{{ $send_company_url }}"></td>
                </tr>
            </table>
        </td>
    </tr>
...
<table border=1>
    ...
    <tr>
        ...
        <td>
            ...
            <br>(리사이징될 파일 넓이 - '%%'구분자사용)<br>예) 600%%290%%160%%110
        </td>
    </tr>
    <tr>
        <td>HEIGHT</td>
        <td>
            ...
            <br>(리사이징될 파일 높이 - '%%'구분자사용)<br>예) 520%%250%%140%%96
        </td>
    </tr>
</table>
@else
