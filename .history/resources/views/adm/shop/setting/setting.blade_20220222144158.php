            ...
            <form>
                ...
                <div class="box_cont">
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="text" name="" placeholder="" value="지구랭">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">대표자명</div>
                        <div class="col">
                            <input type="text" name="" placeholder="" value="유혜현">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">사업자 등록번호</div>
                        <div class="col">
                            <input type="text" name="" placeholder="" value="397-05-01970">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">통신판매업 신고번호</div>
                        <div class="col">
                            <input type="text" name="" placeholder="" value="제 2021-서울마포-3124호">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="text" name="" placeholder="" value="03908">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">사업장주소</div>
                        <div class="col">
                            <input class="wd500" type="text" name="" placeholder="" value="서울특별시 마포구 월드컵북로 361,14층(상암동, DMC이안오피스텔)">
                        </div>
                    </div>
                    <div class="row">
