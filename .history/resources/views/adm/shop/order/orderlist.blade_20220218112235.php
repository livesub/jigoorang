                ...
                <div class="box_search">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <button type="button" class="btn-sm ddd-ln" onclick="javascript:set_date('오늘');">오늘</button>
                            <button type="button" class="btn-sm ddd-ln" onclick="javascript:set_date('어제');">어제</button>
                            <button type="button" class="btn-sm ddd-ln" onclick="javascript:set_date('이번주');">이번주</button>
                            <button type="button" class="btn-sm ddd-ln" onclick="javascript:set_date('이번달');">이번달</button>
                            <button type="button" class="btn-sm ddd-ln" onclick="javascript:set_date('지난달');">지난달</button>
                            <button type="button" class="btn-sm ddd-ln acc" onclick="javascript:set_date('전체');">전체</button>
                        </li>
                        ...
                        <li>
                            <label>
                                <input type="checkbox" name="return_proc" value="N" {{ $return_checked1 }}>미완료건
                            </label>
                            <label>
                                <input type="checkbox" name="return_proc" value="Y" {{ $return_checked2 }}>완료건
                            </label>
                            <label>
                                <input type="checkbox" name="return_proc" value="A" {{ $return_checked3 }}>전체
                            </label>
                        </li>
                        @endif
                    </ul>
