                ...
                @endphp
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="post_num">
                                <div>
                                    <input type="number" name="ad_zip1" id="ad_zip1" value="{{ $order_info->ad_zip1 }}" readonly> <button type="button" class="btn_address adress_input03_btn" onclick="win_zip('wrap_order','ad_zip1', 'ad_addr1', 'ad_addr2', 'ad_addr3', 'ad_jibeon', 'btnFoldWrap_c');" {{ $ad_button }}>
