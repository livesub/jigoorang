                    ...
                    <ul>
                        ...
                        @if($od_status == "교환")
                            @php
                                ...
                                $return_checked2 = "";
                                $return_checked3 = "";
                                if($return_proc == "N" || $return_proc == "") $return_checked1 = "checked";
                                else if($return_proc == "Y") $return_checked2 = "checked";
                                else if($return_proc == "A") $return_checked3 = "checked";
                            @endphp
                        <li>교환</li>
                        <li>
                            <label>
                ...
                <div class="board">
                    ...
                    <div class="btn_area">
                        <div>
                            ...
                            @elseif($od_status == "배송")
                            <button type="button" class="btn-ln ddd-ln"  onclick="order_return('주문확인');">주문확인</button>
                            @endif
                        </div>
                        <div class="right">
