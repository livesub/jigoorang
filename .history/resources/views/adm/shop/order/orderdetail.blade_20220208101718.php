...
<table border=1>
    ...
    <tr>
        <td><textarea name="od_meno" id="od_memo"></textarea></td>
    </tr>
</table>
...
@php
    ...
    if(trim($order_info->od_invoice) != ""){
        $ad_name_readonly = "readonly";
        $ad_hp_readonly = "readonly";
        $ad_ad_zip1_readonly = "readonly";
        $ad_ad_zip1_readonly = "readonly";
        $ad_button = "disabled";
        $ad_addr1_readonly = "readonly";
...
@endphp
    <tr>
        <td>이름</td>
        <td><input type="text" name="ad_name" id="ad_name" value="{{ stripslashes($order_info->ad_name) }}"></td>
    </tr>
    <tr>
        <td>전화번호</td>
        <td><input type="text" name="ad_hp" id="ad_hp" value="{{ $order_info->ad_hp }}"></td>
    </tr>
    <tr>
        <td>우편번호</td>
        <td>
            <input type="text" name="ad_zip1" id="ad_zip1" value="{{ $order_info->ad_zip1 }}" readonly> <button type="button" class="btn_address adress_input03_btn" onclick="win_zip('wrap_order','ad_zip1', 'ad_addr1', 'ad_addr2', 'ad_addr3', 'ad_jibeon', 'btnFoldWrap_c');">우편번호 찾기</button>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="ad_addr2" id="ad_addr2" size="60" placeholder="상세주소" value="{{ $order_info->ad_addr2 }}">
            <input type="text" name="ad_addr3" id="ad_addr3" readonly="readonly" size="60" placeholder="참고항목" value="{{ $order_info->ad_addr3 }}">
            <input type="hidden" name="ad_jibeon" id="ad_jibeon" value="{{ $order_info->ad_jibeon }}">
        </td>
    </tr>
    <tr>
        <td>배송메모</td>
        <td><input type="text" name="od_memo" id="od_memo" value="{{ stripslashes($order_info->od_memo) }}"></td>
    </tr>
</table>
