...
<table border=1>
    ...
    <tr>
        <td>우편번호</td>
        <td>
            <input type="text" name="ad_zip1" id="ad_zip1" value="{{ $order_info->ad_zip1 }}" readonly> <button type="button" class="btn_address adress_input03_btn" onclick="win_zip('wrap_order','ad_zip1', 'od_c_addr1', 'od_c_addr2', 'od_c_addr3', 'od_c_addr_jibeon', 'btnFoldWrap_c');">우편번호 찾기</button>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="hidden" name="ad_jibeon" id="ad_jibeon" value="" value="{{ $order_info->ad_jibeon }}">
        </td>
    </tr>
    <tr>
        <td>배송메모</td>
