...
<table border=1>
    ...
    <tr>
        <td><input type="checkbox" name="ct_chk[]" id="ct_chk_{{ $order->order_id }}" value="{{ $order->order_id }}"></td>
...
<script>
    function order_send_check(){
        ...
        for (i = 0; i < $("input[name^=ct_chk]:checked").length; i++) {
alert($("input[name=ct_chk[]]:checked").val());
/*
