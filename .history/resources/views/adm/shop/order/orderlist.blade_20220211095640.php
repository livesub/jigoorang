...
<table border=1>
    <tr>
        ...
        <td><a href="{{ route('orderlist', 'od_status=준비') }}">주문확인(2)</a></td>
        <td><a href="{{ route('orderlist', 'od_status=배송') }}">발송(2)</a></td>
        <td><a href="{{ route('orderlist', 'od_status=완료') }}">배송완료(2)</a></td>
        <td><a href="{{ route('orderlist', 'od_status=교환') }}">교환반품(2)</a></td>
        <td><a href="{{ route('orderlist', 'od_status=취소') }}">주문취소(2)</a></td>
    </tr>
</table>
