        ...
        <div class="contents_area order">
            ...
            <form>
                ...
                <div class="order_step">
                    <ul>
                        <li>
                            <button type="button" class="acc" onclick="location.href='{{ route('orderlist', 'od_status=입금') }}'">결제완료 ({{ $orders_cnt1 }})</button>
                        </li>
                        <li>
                            <button  type="button" class="" onclick="location.href='{{ route('orderlist', 'od_status=준비') }}'">주문확인 ({{ $orders_cnt2 }})</button>
                        </li>
                        <li>
                            <button type="button" class="" onclick="location.href='{{ route('orderlist', 'od_status=배송') }}'">발송 ({{ $orders_cnt3 }})</button>
                        </li>
                        <li>
                            <button type="button" class="" onclick="location.href='{{ route('orderlist', 'od_status=완료') }}'">배송완료 ({{ $orders_cnt4 }})</button>
                        </li>
                        <li>
                            <button type="button" class="" onclick="location.href='{{ route('orderlist', 'od_status=교환') }}'">교환 ({{ $orders_cnt5 }})</button>
                        </li>
                        <li>
                            <button type="button" class="" onclick="location.href='{{ route('orderlist', 'od_status=상품취소') }}'">주문취소 ({{ $orders_cnt6 }})</button>
                        </li>
                    </ul>
                </div>
                <!-- 주문 단계 탭버튼 끝 -->
                ...
                <div class="box_search">
                    <ul>
                        ...
                        <li>주문일자</li>
                        <li>
                            <input class="aln_left" type="number" name="" placeholder=""><span>~</span>
