...
<table border=1>
    <tr>
        ...
        <td>
            ...
            @else
            결제금액000 : {{ number_format(((int)$order_info->od_cart_price + (int)$order_info->od_send_cost + (int)$order_info->od_send_cost2) - (int)$order_info->od_receipt_point) }}</strong>원</td>
            @endif
    </tr>
</table>
