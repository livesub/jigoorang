...
<table border=1>
    <tr>
        <td><a href="{{ route('orderlist', 'order_type=aa') }}">결제완료(1)</a></td>
        <td><a href="{{ route('orderlist', 'order_type=aa') }}">주문확인(2)</a></td>
        <td><a href="{{ route('orderlist', 'order_type=aa') }}">발송(2)</a></td>
        <td><a href="{{ route('orderlist', 'order_type=aa') }}">배송완료(2)</a></td>
        <td><a href="{{ route('orderlist', 'order_type=aa') }}">교환반품(2)</a></td>
        <td><a href="{{ route('orderlist', 'order_type=aa') }}">주문취소(2)</a></td>
    </tr>
</table>
