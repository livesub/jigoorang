...
<table>
    <tr>
        <td><h4>주문 상세 처리11111111111111111111111</h4></td>
    </tr>
</table>
...
<table border=1>
    ...
    <input type="hidden" name="sct_status" id="sct_status">
        ...
        <tr>
            <td>
                <span onclick="window.open('{{ route('return_popup','order_id='.$order_info->order_id.'&cart_num='.$opt->id) }}', 'PopupWin', 'width=500,height=600');">{{ $return_story }}</span><br>
