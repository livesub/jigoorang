                            ...
                            <table class="ord_detail_table1">
                                ...
                                <thead>
                                    <tr>
                                        <th>교환</th>
                                        <th>상품명</th>
                                        <th><input type="checkbox" id="sit_select_all" name="all_chkbox" value="Y" class="category-1"></th>
                                        <th>옵션</th>
                                        <th>주문수량</th>
                                        <th>구매수량</th>
                                        <th>교환 수량 입력</th>
                                ...
                                @foreach($opts as $opt)
                                    ...
                                    <tr>
                                        ...
                                        <td class="change_num">
                                            ...
                                            @endphp
                                            <input type="number" name="sct_qty[{{ $chk_cnt }}]" id="sct_qty_{{ $chk_cnt }}" value="" onKeyup="this.value=this.value.replace(/[^1-9]/g,'');" style="text-align:right;" {{ $sct_qty_disab }}>
                                        </td>
