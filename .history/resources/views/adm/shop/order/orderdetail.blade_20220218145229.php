                                ...
                                @foreach($opts as $opt)
                                    ...
                                    <tr>
                                        ...
                                        <td class="prd_option">
                                            ...
                                            @endphp
                                            @
                                            <input type="checkbox" name="ct_chk[{{ $chk_cnt }}]" id="ct_chk_{{ $chk_cnt }}" value="{{ $chk_cnt }}" class="mg00 category-1-{{ $chk_box }}-{{ sprintf('%02d',$chk_box2) }}" disabled="disabled">
                                            @else
                                        ...
                                        <td class="change_num">
                                            ...
                                            <input type="number" name="sct_qty[{{ $chk_cnt }}]" id="sct_qty_{{ $chk_cnt }}" value="" onKeyup="this.value=this.value.replace(/[^1-9]/g,'');" style="text-align:right;">
                                        </td>
                                        <td>10,000</td>
                                        <td>0</td>
                                        <td>0P</td>
