            ...
            <form>
                ...
                <div class="box_search">
                    ...
                    <ul>
                        ...
                        <li>
                            <label>
                                <input type="redio" name="return_proc" value="N" {{ $return_checked1 }}>미완료건
                            </label>
                            <label>
                                <input type="redio" name="return_proc" value="Y" {{ $return_checked2 }}>완료건
                            </label>
                            <label>
                                <input type="redio" name="return_proc" value="A" {{ $return_checked3 }}>전체
                            </label>
                        </li>
                        @endif
                    </ul>
