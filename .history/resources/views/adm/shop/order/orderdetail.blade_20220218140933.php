                                    ...
                                    <tr>
                                        ...
                                        <td class="prod_name" rowspan="{{ $rowspan }}">
                                            <div>
                                                ...
                                                <div>
                                                    {{ stripslashes(mb_substr($cart->item_name, 0, 20, 'utf-8')) }}
<!--
...
-->
                                        ...
                                        <td rowspan="{{ $rowspan }}">
                                            <input type="checkbox" class="mg00" id="sit_sel_{{ $i }}" name="it_sel[]" value="{{ $cart->item_code }}" class="category-1-{{ $chk_box }}">
                                        </td>
<!--
