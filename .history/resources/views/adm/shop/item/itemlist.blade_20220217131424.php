                ...
                <form name="search_form" id="search_form" method="get" action="{{ route('shop.item.index') }}">
                    <ul>
                        ...
                        <li>
                            ...
                            <label>
                                <input type="checkbox" id="item_special" checked="checked">기획전1
                            </label>
                            <label>
                                <input type="checkbox" id="item_special2" checked="checked">기획전2
                            </label>
                            <label>
                                <input type="checkbox" id="item_new_arrival" checked="checked">New Arrivals
                            </label>
                        </li>
                        <li>상품</li>
                        <li>
