                ...
                <div class="box_cont">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="item_rank" id="item_rank" maxlength="4" size="4" value="9999" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" placeholder="">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="opt_list">
                                ...
                                <button type="button" class="btn blk-ln mb10" onclick="">선택 삭제</button>
                                <div class="board">
                                    <table class="option">
                                        <colgroup>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="opt_title"><div>S > 빨</div></td>
                                            ...
                                            <tr>
                                                <td><input type="checkbox" class="mg00" id=""></td>
                                                <td class="opt_title"><div>S > 주</div></td>
                                                <td><input type="number" name="" placeholder=""></td>
                                                <td><input type="number" name="" placeholder=""></td>
                                                <td>
                                                    <select>
                                            ...
                                            <tr>
                                                <td><input type="checkbox" class="mg00" id=""></td>
                                                <td class="opt_title"><div>M > 빨</div></td>
                                                <td><input type="number" name="" placeholder=""></td>
                                                <td><input type="number" name="" placeholder=""></td>
                                                <td>
                                                    <select>
                                            ...
                                            <tr>
                                                <td><input type="checkbox" class="mg00" id=""></td>
                                                <td class="opt_title"><div>M > 주</div></td>
                                                <td><input type="number" name="" placeholder=""></td>
                                                <td><input type="number" name="" placeholder=""></td>
                                                <td>
                                                    <select>
                                ...
                                <button type="button" class="btn blk-ln mb10" onclick="">일괄 적용</button>
                                <div class="board">
                                    <table class="option2">
                                        <colgroup>
                                            <col style="width: 40px;">
