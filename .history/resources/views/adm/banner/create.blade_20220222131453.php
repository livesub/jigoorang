                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="prt">
                                ...
                                <label>
                                    <input type="radio" name="b_display" id="b_display_no" value="N"> 미출력
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="input_link">
                                <input type="text" name="b_link" id="b_link">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="file_att">
                                ...
                                <div class="btn_file">
                                    <label>
                                        파일첨부
                                        <input type="file" name="b_pc_img" id="b_pc_img" accept="image/*">
                                    </label>
                                    asdfasdf.png
                                    <!-- 선택된 파일이 없습니다. -->
                                </div>
