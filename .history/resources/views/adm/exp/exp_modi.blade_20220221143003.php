        ...
        <div class="contents_area expr">
                <div class="box_cont">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="date">
                                <input type="text" id="exp_date_start" name="exp_date_start" value="{{ $result_expList->exp_date_start }}"> ~ <input type="text" id="exp_date_end" name="exp_date_end" value="{{ $result_expList->exp_date_end }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="date">
                                <input type="text" id="exp_review_start" name="exp_review_start" value="{{ $result_expList->exp_review_start }}"> ~ <input type="text" id="exp_review_end" name="exp_review_end" value="{{ $result_expList->exp_review_end }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="date">
                                <input type="text" id="exp_release_date" name="exp_release_date" value="{{ $result_expList->exp_release_date }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
