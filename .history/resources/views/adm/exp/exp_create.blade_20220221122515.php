        ...
        <div class="contents_area expr">
                <div class="box_cont">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="date">
                                <input type="date" id="exp_review_start" name="exp_review_start" value="{{ old('exp_review_start') }}"> ~ <input type="date" id="exp_review_end" name="exp_review_end" value="{{ old('exp_review_end') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
