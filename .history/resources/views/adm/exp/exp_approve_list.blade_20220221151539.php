            ...
            <form>
                <div class="box_cont">
                    ...
                    @php
                        ...
                        if($seach_select != ""){
                            if($seach_select == "user_id") $seach_selected1 = "selected";
                            else if($seach_select == "user_name") $seach_selected2 = "selected";
                            else if($seach_select == "user_phone") $seach_selected2 = "selected";
                        }
                        $k = 1;
                    @endphp
                    ...
                    <ul>
                        ...
                        <li>
                            <select name="seach_select">
                                ...
                                <option value="user_phone">휴대폰 번호</option>
                            </select>
                            <input class="wd250" type="text" name="seach_keyword" id="seach_keyword">
                        </li>
                    </ul>
