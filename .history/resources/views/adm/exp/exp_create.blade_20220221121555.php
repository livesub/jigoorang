        ...
        <div class="top">
            <div class="title">
                ...
                <div class="button_box">
                    <button type="button" onclick="location.href='../../page/experience/experience.html'">등록<!-- 수정 --></button>
                </div>
            </div>
        </div>
        ...
        <div class="contents_area expr">
                <div class="box_cont">
                    <div class="row">
                        ...
                        <div class="col">
                            <input class="wd800" type="text" name="" placeholder="">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="number" name="" placeholder=""> 명
                        </div>
                    </div>
                    <div class="row">
