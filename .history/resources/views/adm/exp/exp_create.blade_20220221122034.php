        ...
        <div class="contents_area expr">
                <div class="box_cont">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="date">
                                <input type="number" id="exp_date_start" name="exp_date_start" value="{{ old('exp_date_start') }}"> ~ <input type="date" id="exp_date_end" name="exp_date_end" value="{{ old('exp_date_end') }}"> ~
