...
-->
                        ...
                        <tbody>
                            ...
                            @php
                                ...
                                //신청자수
                                $exp_application_list_cnt = DB::table('exp_application_list')->where('exp_id', $expAllList->id)->count();
                                $now_date = date("Y-m-d");
...
-->
                                ...
                                <td>{{ number_format($exp_application_list_cnt) }}</td>
                                ...
                                <td>{{ $ment }}</td>
                                <td><button type="button" class="btn-sm-ln" onclick="location.href='exp_modi({{ $expAllList->id }});">수정</button></td>
