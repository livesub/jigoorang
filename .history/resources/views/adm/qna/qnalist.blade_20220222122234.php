                    ...
                    <ul>
                        ...
                        <li>
                            @php
                                ...
                                else if($qna_cate == "취소/교환/반품 관련") $qna_cate_selected5 = "selected";
                ...
                <div class="board">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $virtual_num }}</td>
                                <td class="title"><a href="{{ route('adm.qna_answer','id='.$qna_row->id.'&page='.$page.'&keyword='.$keyword) }}">{{ stripslashes($qna_row->qna_subject) }}</a></td>
                                <td>상품관련</td>
                                <td>김치맨</td>
