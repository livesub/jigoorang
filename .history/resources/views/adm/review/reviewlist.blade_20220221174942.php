...
-->
                                ...
                                <td rowspan="2"><button type="button" onclick="review_blind('{{ $review_save_row->id }}', '{{ $review_save_row->review_blind }}')" class="btn-ln">{{ $blind_ment }}</button></td>
                                <td rowspan="2"><button type="button" onclick="review_modi('{{ $review_save_row->id }}')" class="btn-ln">수정</button></td>
                            </tr>
                            <tr>
