            ...
            <form>
                ...
                <div class="box_search">
                    <ul>
                        ...
                        @endphp
                            <select name="ca_id" id="ca_id" onchange="select_cate(this)">
                            ...
                            <select id="s_cate" style="display:none">
                                <option>선택</option>
                                <option>가나다 치약</option>
                                <option>일이삼 치약</option>
                                <option>에이비씨 치약</option>
                            </select>
                        </li>
                        <li>형태</li>
                        <li>
...
<script>
    function select_cate(x_cate){
        $.ajax({
            type : 'get',
            url : '{{ route('adm.review.ajax_scate') }}',
            data : {
            },
            dataType : 'text',
