            ...
            <!-- 가이드 문구 끝-->
                ...
                <form name="search_form" id="search_form" method="get" action="">
                    <ul>
                        ...
                        <li>
                            <label>
                                <input type="radio" id="review_type1" name="review_type" value="all" checked="checked">전체
                            </label>
                            <label>
                                <input type="radio" id="review_type2" name="review_type" value="shop" >구매 리뷰
                            </label>
                            <label>
                                <input type="radio" id="review_type3" name="review_type" value="exp" >체험단 리뷰
                            </label>
                        </li>
                        <li>노출여부</li>
                        <li>
                            <label>
                                <input type="radio" id="review_blind1" name="review_blind1" value="all" checked="checked">전체
                            </label>
                            <label>
                                <input type="radio" id="review_blind2" name="review_blind" value="N" >노출 리뷰
                            </label>
                            <label>
                                <input type="radio" id="review_blind2" name="review_blind" value="Y" >블라인드 리뷰
                            </label>
                        </li>
                        <li>작성자</li>
                        <li>
