                ...
                <form name="search_form" id="search_form" method="get" action="">
                    <ul>
                        ...
                        @php
                            $user_selected1 = "";
                            $user_selected2 = "";
                            if($user_info == "user_name") $user_selected1 = "selected";
                            else if($user_info == "user_id") $user_selected2 = "selected";
                        @endphp
...
-->
                                ...
                                <td rowspan="2">{{ $review_save_row->created_at }}</td>
                                <td rowspan="2">{{ $temporary_yn_ment }}</td>
                                <td rowspan="2"><button type="button" onclick="review_blind('{{ $review_save_row->id }}', '{{ $review_save_row->review_blind }}')" class="button.btn-sm-ln-bk">{{ $blind_ment }}</button></td>
                                <td rowspan="2"><button type="button" onclick="review_modi('{{ $review_save_row->id }}')" class="btn-sm-ln">수정</button></td>
                            </tr>
                            <tr>
                                <td class="title">{{ $title_ment }}</td>
                            </tr>
                        </tbody>
                        @php
                            $virtual_num--;
