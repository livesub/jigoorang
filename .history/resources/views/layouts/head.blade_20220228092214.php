...
<div class="wrap">
    ...
    <div class="tabar">
        <ul>
            <li><span>홈</span></li>
            <li><span onclick="javascript:alert('22 년 2 월 OPEN  예정');">랭킹</span></li>
            <li><span onclick="javascript:alert('22 년 2 월 OPEN  예정');">쇼핑</span></li>
            <li><span href="{{ route('notice') }}">소식</span></li>
        </ul>
    </div>
    <!-- 탭바 끝 -->
