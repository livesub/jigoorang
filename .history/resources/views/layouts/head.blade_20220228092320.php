...
<div class="wrap">
    ...
    <div class="tabar">
        <ul>
            <li onclick="location.href='{{ route('sitem','ca_id='.$ca_id.'&cate='.$cate.'&sub_ca_id=all&sub_cate=0') }}'"><span>홈</span></li>
            <li onclick="javascript:alert('22 년 2 월 OPEN  예정');"><span>랭킹</span></li>
            <li onclick="javascript:alert('22 년 2 월 OPEN  예정');"><span>쇼핑</span></li>
            <li onclick="javascript:alert('22 년 2 월 OPEN  예정');"><span>소식</span></li>
        </ul>
    </div>
    <!-- 탭바 끝 -->
