@php
    ...
    else if($path_cut[0] == "shop.index") $menu_shop = ' class="on" ';
    ...
    <div class="header">
        ...
        <div class="btm">
            <ul class="navi">
                ...
                <li {!! $menu_ranking !!}><a href="{{ route('ranking_list') }}"><b>지</b>구를 <b>구</b>하는 <b>랭</b>킹</a></li>
                <li {!! $menu_exp !!}><a href="{{ route('shop.index') }}"><b>지</b>구를 <b>구</b>하는 <b>쇼</b>핑</a></li>
                <li {!! $menu_exp !!}><a href="{{ route('notice') }}"><b>지</b>구를 <b>구</b>하는 기<b>록</b></a></li>
