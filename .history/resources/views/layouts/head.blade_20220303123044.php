@php
    ...
    if($path_cut[0] == "exp" || $path_cut[0] == "list") $menu_exp = ' class="on" ';
    ...
    else if($path_cut[0] == "notice" || $path_cut[0] == "notice_view") $menu_notice = ' class="on" ';
...
<head>
    ...
    <meta name = keywords" content="친환경제품추천, 친환경제품리뷰, 샴푸바추천, 설거지비누추천, 제로웨이스트">
...
<div class="wrap">
            ...
            <div id="Sidenav" class="sidenav">
                ...
                <div class="m-menu">
                    ...
                    <ul class="m-menu-child">
                        ...
                        <a href="{{ route('notice') }}">
                                <li {!! $menu_notice !!}><b>지</b>구를 <b>구</b>하는 기<b>록</b> </li>
                        </a>
    ...
    <div id="load">
        <img src="{{ asset('/design/recources/icons/icon-cls.png') }}" alt="loading">
    </div>
