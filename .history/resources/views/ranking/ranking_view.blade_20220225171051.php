                    ...
                    <div class="scrollmenu sub_sol">
                        <div class="swiper submenu_sol">
                            ...
                            @foreach($rank_cate_infos as $rank_cate_info)
                                ...
                                @endphp
                              <li class="swiper-slide" onClick="location.href='{{ route('sitem','ca_id='.$ca_id.'&cate='.$cate.'&sub_ca_id=all&sub_cate=0') }}'"><a href="{{ route('ranking_view','sca_id='.$rank_cate_info->sca_id.'&sub_cate='.$sub_cate_num) }}"><span class="{{ $sca_id_class }}">{{ $rank_cate_info->sca_name_kr }}</span></a></li>
                                @php
                                    $sub_cate_num++;
                                @endphp
                            @endforeach
