      ...
      <div class="modal-container-body">
          ...
          <div class="scroll">
            @foreach($order_infos as $order_info)
                @php
                    $cart_infos = DB::table('shopcarts')->where([['user_id', Auth::user()->user_id], ['od_id', $order_info->order_id]])->get();
                    $item_infos = DB::table('shopitems')->where('item_code', $cart_infos->item_code]])->first();
                @endphp
