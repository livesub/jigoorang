    ...
    <div class="sub-container">
        ...
        <input type="hidden" name="form_route" id="form_route" value="{{ route('mypage.review_possible_save') }}">
                ...
                <div class="board_wrap">
                      ...
                      <div class="information review">
                        ...
                        <div class="information review">
                         ...
                         <div class="noties">
                            <p><span>등록 이후, 삭제나 재작성은 불가합니다.</span><br>
                               작성한 내용에 이상이 없는지 확인하시고, 등록을 눌러 주세요.</p>
                         </div>
            ...
            <div class="btn-3ea">
                ...
                <button type="button" class="btn-50" id="tmp_save_y" onclick="review_save('y'); loadshow(review_save);">임시저장</button>
