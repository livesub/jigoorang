                ...
                @if(count($orders) > 0)
                    ...
                    <div class="list ev_rul bd-02">
                        ...
                        @php
                            ...
                            $day_30_tmp = strtotime($order->created_at." +15 days");    // 30기준이나 구매 완료 시점이 결제후 9일 이기에 21일 계산
                            $day_30 = date('Y-m-d H:i:s', $day_30_tmp);
var_dump("created_at====> ".$order->created_at);
var_dump("now_date====> ".$now_date);
var_dump("day_30====> ".$day_30);
                            if($now_date > $day_30){
var_dump("들어옴!!");
                            }
