                ...
                <div class="board_wrap">
                    ...
                    <div class="list view">
                        <div class="body view">
                            ...
                            <div class="ordernumber"><p onclick="location.href='{{ route('mypage.orderview') }}'">주문번호 {{ $qna_info->order_id }}</p></div>
                            @endif
                            <div class="view_text">
                    ...
                    <div class="list view">
                        <div class="body view">
                           <div class="view_icon"><h4>지구랭</h4></div>
                            <div class="view_text_02">
                                <p>{{ $qna_info->qna_answer }}</p>
