                ...
                <div class="board_wrap">
                    ...
                    <div class="list">
                        ...
                        {!! csrf_field() !!}
                            ...
                            <a href="{{ route('terms_use') }}"><label for="" class="line">이용약관
                                <span>(필수)</span></label></a><!-- 약관동의 페이지 링크 -->
                            </li>
                            <li>
                            <!--<input type="checkbox" id="pro_agree" name="pro_agree" checked disabled>-->
                            <a href="{{ route('privacy') }}"><label for="" class="line">개인정보 처리방침
                                <span>(필수)</span></label></a><!-- 개인정보 보호 페이지 링크 -->
                            </li>
                        </form>
                        </ul>
                        </div>
    ...
    <div class="modal-background" onclick=""></div>
        <div class="modal-container num pw">
            ...
            <div class="modal-container-body num pw">
                <div class="pw_input">
                    <input type="password" id="user_pw" name="user_pw" placeholder="비밀번호 입력(영문,숫자,특문조합 8~20자(%$?^()제외)">
                    <p id="pw_error"></p>

                    <input type="password" id="user_pw_confirmation" name="user_pw_confirmation" placeholder="위 비밀번호를 다시 입력해 주세요">
