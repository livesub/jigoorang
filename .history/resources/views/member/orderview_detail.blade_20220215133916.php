                ...
                <div class="board_wrap">
                        ...
                        <div class="list ev_rul pd-30">
                            ...
                            <div class="btn_re point01">
                                <ul class="re_li">
                                    <li class="dl-trk"><!--<a href="{{ $order_info->od_delivery_url }}"-->
                                      <a href="https://service.epost.go.kr/iservice/usr/trace/usrtrc001k01.jsp">target="_blank"><span>배송조회</span></a></li>
                                </ul>
                            </div>
                        </div>
