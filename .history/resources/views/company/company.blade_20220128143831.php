            ...
            <div class="board mypage_list">
                ...
                <div class="board_wrap">
                    ...
                    <div class="about">
                        ...
                        <img src="{{ asset('/design/recources/imgs/bitmap04@3x.png') }}" alt="" onclick="detilopenmodal_001()">
                        <img src="{{ asset('/design/recources/imgs/bitmap05@3x.png') }}" alt="">
                        <a href="{{ route('exp.list') }}"><img src="{{ asset('/design/recources/imgs/bitmap06@3x.png') }}" alt="" id=""></a>
