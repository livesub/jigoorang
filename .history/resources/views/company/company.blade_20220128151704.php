            ...
            <div class="board mypage_list">
                ...
                <div class="board_wrap">
                    ...
                    <div class="about none">
                        ...
                        <img src="{{ asset('/design/recources/imgs/bitmap_m_03@3x.png') }}" alt="">
                        <img src="{{ asset('/design/recources/imgs/bitmap_m_04@3x.png') }}" alt="" onclick="detilopenmodal_001()" id="rink">
