                  ...
                  <form name=Join action="{{ route('join.create', 'Y') }}"  onSubmit="return CheckForm(this)" class="join_agree">
                    ...
                    <div class="agree_01">
                        ...
                        <div class="agree_01">
                            ...
                            <label for="개인정보 처리방침">개인정보 처리방침 <span class="point">(필수)</span></label>

                            <div class="agree_box">
                            <p></p>< 지구랭 >('jigoorang.com'이하 '지구랭')은 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.<br>
