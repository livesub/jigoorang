...
//$success = true;
    ...
    public function return_sign_up(Request $request)
    {
        ...
        $order_info = DB::table('shoporders')->where([['order_id', $order_id], ['user_id', "aa"]])->first();
        $carts = DB::table('shopcarts')->where([['user_id',Auth::user()->user_id],['od_id', $order_info->order_id], ['id', $cart_num]])->get();
