...
class AdmReviewMangerController extends Controller
{
    ...
    public function review_modi_save(Request $request)
    {
        ...
        DB::table('review_saves')->where('id', $rs_id)->delete();
        return redirect(route('adm.review.reviewlist', 'page='.$page.'&ca_id='.$ca_id.'&item_search='.$item_search.'&keyword='.$keyword))->with('alert_messages', '수정 되었습니다.');
    }
}
