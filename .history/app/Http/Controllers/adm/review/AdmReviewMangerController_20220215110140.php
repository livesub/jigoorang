...
class AdmReviewMangerController extends Controller
{
    ...
    public function review_modi_save(Request $request)
    {
        ...
        //return redirect(route('adm.review.reviewlist', 'page='.$page.'&ca_id='.$ca_id.'&item_search='.$item_search.'&keyword='.$keyword))->with('alert_messages', $Messages::$item['update']['up_ok']);
    }
}
