...
class AdmReviewMangerController extends Controller
{
    ...
    public function review_modi_save(Request $request)
    {
        ...
        for($i = 1; $i <= 5; $i++){
            ...
            $review_save = DB::table('review_save_imgs')->where('id', $num)->first();
...
/*
                        ...
                        for($y = 0; $y < count($data_img_tmp); $y++){
                            ...
                            //이미지 저장 처리
                            $create_img_result = review_save_imgs::create($data);
...
exit;
                    ...
                    if($review_save != ""){
                        ...
                        DB::table('review_save_imgs')->where([['id', $review_id], ['rs_id', ]])->delete();
                    }
                }
            }
