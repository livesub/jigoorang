        ...
        if($success == true){
            ...
            foreach($all_cart_infos as $all_cart_info){
                ...
                $data = array(
                    ...
                    'sct_status'        => '쇼핑',
                    'sct_history'       => '',
                    'sct_price'         => $all_cart_info->item_price,
                    'sct_point'         => $all_cart_info->point,
                    'sct_point_use'     => 0,
                    'sct_stock_use'     => 0,
                    ...
                    'sct_direct'        => $all_cart_info->sw_direct,
                    'sct_select'        => $all_cart_info->sct_select,
                ...
                $in_result->save();
/*
                $sam_opt = DB::table('shopcarts')->select('id','sio_type','sct_qty')->where([['od_id', $tmp_cart_id], ['item_code', $all_cart_info->item_code], ['sio_id', $all_cart_info->sio_id], ['sct_status','쇼핑'], ['sct_direct','0']])->get();
                ...
                if(isset($sam_opt[0]->id) && $sam_opt[0]->id) {
                    ...
                    $up_result->sct_qty = $up_result->sct_qty + $all_cart_info->sct_qty;
                    $result_up = $up_result->save();
var_dump("EEEEEEEEEEEEEE====> ".$tmp_ct_qty);
                }else{
