...
*/
                        ...
                        $sct_option_name = mb_substr($cart_info->sct_option, 0, 14, 'utf-8')."...";
                        $mod_history .= date("Y-m-d H:i:s", time()).' '.$cart_info->sct_option.' 교환 '.$cart_info->sct_qty.' -> 0     '.$user_name."   ".$user_id."\n";
                    }
                }
