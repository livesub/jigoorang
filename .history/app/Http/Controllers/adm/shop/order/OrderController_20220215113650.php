...
*/
    ...
    {
        $CustomUtils = new CustomUtils;
//http://localhost:8000/adm/shop/order_excel?&sel_field=user_id&search=ysz@yongsanzip.com&od_status=%EC%9E%85%EA%B8%88&fr_date=2022-02-06&to_date=2022-02-12&order_sort=
        $sel_field          = $request->input('sel_field');
        $search             = $request->input('search');
        $od_status          = $request->input('od_status');
        $fr_date            = $request->input('fr_date');
