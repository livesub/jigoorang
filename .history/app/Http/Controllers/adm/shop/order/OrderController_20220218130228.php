...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $page_move = "&page=$page&sel_field=$sel_field&search=$search&od_status=$od_status&fr_date=$fr_date&to_date=$to_date&return_proc=$return_proc&order_type=$order_type";
        $sort_page_move = "&sel_field=$sel_field&search=$search&od_status=$od_status&fr_date=$fr_date&to_date=$to_date&return_proc=$return_proc&order_type=$order_type";
