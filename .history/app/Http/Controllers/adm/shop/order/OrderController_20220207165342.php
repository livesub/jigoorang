...
exit;
/*
                if($order_info->od_return_point >= $return_point){
                    //누적 반환 포인트
                    $return_point = DB::table('shoporders')->where([['order_id', $order_id], ['imp_uid', $imp_uid]])->update([
                        'od_return_point' => 0,
                    ]);
