...
var_dump("tmp_cart_id====> ".$tmp_cart_id);
...
//                $sam_opt = DB::table('shopcarts')->select('id','sio_type','sct_qty')->where([['od_id', $tmp_cart_id], ['item_code', $all_cart_infos->item_code], ['sio_id', $all_cart_infos->sio_id], ['sct_status','쇼핑'], ['sct_direct','0']])->get();
/*
                if(isset($sam_opt[0]->id) && $sam_opt[0]->id) {
var_dump("EEEEEEEEEEEEEE");
                }else{
