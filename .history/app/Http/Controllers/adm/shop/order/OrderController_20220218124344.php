...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($order_sort == "" || $order_sort == "desc"){
            $order_rows = $orders->orderby('id1', 'desc')->offset($start_num)->limit($pageScale)->get();
        }else{
            $order_rows = $orders->orderby('id1', 'asc')->offset($start_num)->limit($pageScale)->get();
        }
var_dump($order_rows);
        $tailarr = array();
