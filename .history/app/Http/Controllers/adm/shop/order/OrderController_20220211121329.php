...
*/
        ...
        $orders_cnt6 = DB::table('shoporders')->where('od_status', '취소')->count();    //취소 건
...
*/
    ...
    public function test_cancel(Request $request){
        $od_id     = $request->input('od_id');

var_dump("KKKKKKKKKKKK===> ".$od_id);
    }
...
//exit;
    ...
    public function ajax_itemspaycancel(Request $request)
    {
        ...
        $refund_bank            = $request->input('refund_bank');
        $refund_account         = $request->input('refund_account');
var_dump("ajax_itemspaycancel====> ".$imp_uid);
exit;
        $order_id               = $merchant_uid;
