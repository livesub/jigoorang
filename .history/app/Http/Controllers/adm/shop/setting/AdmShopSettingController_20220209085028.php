...
class AdmShopSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        $photo_point            = "100";
        $tot_item_point         = "1";
        $send_company_name      = "배송업체명";
        $send_company_tel       = "배송업체전화번호";
        $send_company_url       = "https://naver.com";
        ...
        if(!is_null($setting_info)){
            ...
            $send_company_name      = $setting_info->send_company_name;
            $send_company_tel       = $setting_info->send_company_tel;
            $send_company_url       = $setting_info->send_company_url;
        }
        ...
        return view('adm.shop.setting.setting',[
            ...
            'send_company_tel'      => $send_company_tel,
            'send_company_url'      => $send_company_url,
        ]);
    }
    ...
    public function savesetting(Request $request)
    {
        ...
        $send_company_name      = $request->input('send_company_name');
        $send_company_tel       = $request->input('send_company_tel');
        $send_company_url       = $request->input('send_company_url');
        ...
        $data = array(
            ...
            'send_company_name'     => addslashes($send_company_name),
            'send_company_tel'      => $send_company_tel,
            'send_company_url'      => $send_company_url,
        );
