...
*/
    ...
    public function ajax_member_point_save(Request $request)
    {
        ...
        if($give_point_chk == 1) $save_give_point = $give_point;
        else if($give_point_chk == 2) $save_give_point = (-1) * $give_point;
var_dump("save_give_point===> ".$save_give_point);
exit;
        $CustomUtils->insert_point($members->user_id, $save_give_point, '상품 구매 취소', 11, '', '');

var_dump($give_point_chk);
    }
