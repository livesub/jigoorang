...
exit;
        ...
        if($give_point_chk == 1) $give_po = $give_point;
        else if($give_point_chk == 2) $give_po = (-1) * $give_point;

        $CustomUtils->insert_point($members->user_id, $hap_qty_price, '상품 구매 취소', 11, '', '');
