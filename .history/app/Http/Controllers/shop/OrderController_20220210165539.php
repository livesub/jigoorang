...
class OrderController extends Controller
{
    ...
    public function orderform(Request $request)
    {
        ...
        $cart_infos = DB::table('shopcarts as a')
            ...
            if($sw_direct){
                $cart_infos = $cart_infos->where([['a.sct_select','1'],['a.sct_direct', '1'], ['a.sct_status','쇼핑'], ['user_id', Auth:user()->user_id]]);
            }else{
                $cart_infos = $cart_infos->where([['a.sct_select','1'], ['a.sct_direct', '0'], ['a.sct_status','쇼핑'], ['user_id', Auth:user()->user_id]]);
            }
            //->groupBy('a.item_code')
