...
*/
    ...
    public function ajax_ordertemp(Request $request)
    {
        ...
        $tot_item_point     = ($od_receipt_price - $od_temp_point - $tmp_de_send_cost - $od_send_cost - $od_send_cost2) * ($setting_info->tot_item_point / 100);
$aa = $od_receipt_price - $od_temp_point - $tmp_de_send_cost - $od_send_cost - $od_send_cost2;
var_dump($od_receipt_price);
exit;
        if($ordertemp_cnt == 0){
