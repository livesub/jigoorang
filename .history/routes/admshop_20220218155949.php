...
/*** 주문 관리 */
    ...
    Route::get('return_popup', [
        'as' => 'ajax_return_popup',
        'uses' => 'App\Http\Controllers\adm\shop\order\OrderController@ajax_return_popup',
    ]);

    //교환 팝업 처리
    Route::post('return_popup_process', [
        'as' => 'return_popup_process',
        'uses' => 'App\Http\Controllers\adm\shop\order\OrderController@return_popup_process',
    ]);
